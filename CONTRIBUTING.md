...
- **PR을 만들면 단톡에 링크를 공유하고 확인을 요청합니다.**
  GitHub의 **Reviewer 지정은 필수가 아닙니다.** 단톡 공유로 갈음합니다. (지정하고 싶으면 해도 됩니다)
- **수정 요청이 오면 반영한 뒤 머지합니다.**
- **머지는 PR을 올린 사람이 직접 합니다.**
...
2. **담당 영역 밖 파일을 건드리지 않았는가** — 필요한 변경이었다면 그 담당자에게 단톡으로 확인을 요청
